    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10 border border-gray-200 w-full">
      ...
      <div className="space-y-4 md:space-y-6">
        {[
          ...
          <div 
            key={index} 
            className="flex items-start space-x-3 md:space-x-4 text-center md:text-left"
          >
            <Icon className="text-[#1a237e] text-lg md:text-2xl flex-shrink-0" />
            <span className="text-sm md:text-lg text-gray-700 break-words max-w-full">
              {text}
            </span>
          </div>
        ))}
