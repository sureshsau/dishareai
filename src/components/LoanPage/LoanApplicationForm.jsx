...
const LoanApplicationForm = () => {
  const handleDownloadDoc = () => {
    const fileUrl = "/assets/ApplicationForm.doc";
    const link = document.createElement("a");
    link.href = fileUrl;
    link.download = "Loan_Application_Form.doc";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      {/* Form Image */}
      <div className="max-w-lg w-full bg-white shadow-lg rounded-lg overflow-hidden p-4">
        <img
          src={formScreenshot}
          alt="Form Preview"
